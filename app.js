    ...
    for (let i = 0; i < myFriends.length; i++) {
        ...
        for (let j = 99; j > 0; j--) {
            ...
            if (j > 2) {
                ...
                pText = document.createTextNode(j + "lines of code in the file," + j + "lines of code;" + myFriends[i] + "strike one outerHeight, clears it all out, no more lines of code in the file");
